 ...
 * Homepage: https://shopilo.it/negozi/swarovski.it
 */

const SHOPILO_URL = "https://shopilo.it/negozi/swarovski.it";
const STORE_NAME  = "Swarovski";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-it/codice-sconto-swarovski)" }
  });
