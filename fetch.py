#!/usr/bin/env python3
"""
Recupero codici sconto Swarovski da shopilo.it
Sursa: https://shopilo.it/negozi/swarovski.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/swarovski.it"
STORE_NAME = "Swarovski"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Swarovski da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-swarovski)"
    }
    try:
